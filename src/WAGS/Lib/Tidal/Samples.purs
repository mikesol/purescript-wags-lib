...
instance entropyUnsampledTimeIs :: Entropy (UnsampledTimeIs event) where
...
instance clockTimeTimeIs :: ClockTime (TimeIs event) where
...
instance initialEntropyTimeIs :: InitialEntropy (TimeIs event) where
...
instance bigCycleTimeTimeIs :: BigCycleTime (TimeIs event) where
...
instance littleCycleTimeTimeIs :: LittleCycleTime (TimeIs event) where
...
instance normalizedClockTimeTimeIs :: NormalizedClockTime (TimeIs event) where
...
instance normalizedBigCycleTimeTimeIs :: NormalizedBigCycleTime (TimeIs event) where
...
instance normalizedLittleCycleTimeTimeIs :: NormalizedLittleCycleTime (TimeIs event) where
...
instance littleCycleDurationTimeIs :: LittleCycleDuration (TimeIs event) where
...
instance bigCycleDurationTimeIs :: BigCycleDuration (TimeIs event) where
...
nameToSampleMNO :: forall event. Object (Maybe (Note event))
