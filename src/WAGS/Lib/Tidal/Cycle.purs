...
import WAGS.Graph.Parameter (Maybe', _just, _nothing, _maybe)
...
c2d = firstCycle >>> _maybe _nothing _just >>> map S.note2drone
...
cycleFromSample' weight sample = singleton
  { env: { weight, tag: _nothing }
  , val: _just (noteFromSample sample)
  }
...
r = singleton { val: _nothing, env: { weight: 1.0, tag: _nothing } }
