  ...
  describe "Tests blip" do
    it "Changes the latched value only when there is a change" do
      let
        ...
        r0 = makeLatchAP (pw { time: 0.04, headroom: 0.02 })

        r1 = unwrapCofree r0 (pw { time: 0.70, headroom: 0.02 })

        r2 = unwrapCofree r1 (pw { time: 0.99, headroom: 0.02 })

        r3 = unwrapCofree r2 (pw { time: 0.995, headroom: 0.02 })

        r4 = unwrapCofree r3 (pw { time: 1.4, headroom: 0.02 })

        r5 = unwrapCofree r4 (pw { time: 2.0, headroom: 0.02 })

        r6 = unwrapCofree r5 (pw { time: 2.3, headroom: 0.02 })
