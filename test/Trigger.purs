...
testTrigger = do
  describe "Tests trigger" do
    it "Produces the correct time for a snappy trigger" do
      let
        r0 = makeSnappyTrigger { time: 0.0, headroomInSeconds: 0.02, freq: 1.0 }

        r1 = unwrapCofree r0 { time: 0.1, freq: 1.0, headroomInSeconds: 0.02 }

        r2 = unwrapCofree r1 { time: 0.95, freq: 1.0, headroomInSeconds: 0.06 }
        r3 = unwrapCofree r2 { time: 1.4, freq: 1.0, headroomInSeconds: 0.06 }
    ...
    it "Produces the correct time for a 2x speed snappy trigger" do
      let
        r0 = makeSnappyTrigger { time: 0.0, headroomInSeconds: 0.02, freq: 2.0 }

        r1 = unwrapCofree r0 { time: 0.1, freq: 2.0, headroomInSeconds: 0.02 }

        r2 = unwrapCofree r1 { time: 0.48, freq: 2.0, headroomInSeconds: 0.03 }

        r3 = unwrapCofree r2 { time: 0.78, freq: 2.0, headroomInSeconds: 0.03 }
